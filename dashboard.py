...
class IMS:
    def __init__(self,root):
        ...
        #=============================================Content====================================================================================
        self.lbl_employee=Label(self.root,text="Total Employee\n[ 0 ]",bd=5,relief=RIDGE,bg="#44bbf9",fg="white",font=("goudy old style",20,"bold"))
        ...
        #===============================================================footer========================================================
        lbl_footer=Label(self.root,text="RC-Infra Inventory Management System | Developed by Abhinav\n Technical Issue Contact-9511195090",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
