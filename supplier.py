...
class supplierClass:
    def __init__(self,root):
        ...
        #=======================================row2=======================================================
        lbl_name =Label(self.root,text="Supplier",font =("goudy  old style", 15) ,bg ="white", ).place(x=50, y=120)
        txt_name =Entry(self.root,textvariable=self.var_name,font =("goudy  old style", 15) ,bg ="lightyellow" ).place(x=180, y=130,width=180)
       

         #=======================================row3=======================================================
        lbl_contact =Label(self.root,text="Contact",font =("goudy  old style", 15) ,bg ="white", ).place(x=50, y=160)
        txt_contact =Entry(self.root,textvariable=self.var_contact,font =("goudy  old style", 15) ,bg ="lightyellow" ).place(x=180, y=170,width=180)
        

  #=======================================row4=======================================================
        lbl_desc =Label(self.root,text="Desciption",font =("goudy  old style", 15) ,bg ="white", ).place(x=50, y=200)
        self.txt_desc = Text(self.root, font=("goudy old style", 15), bg="lightyellow")
        self.txt_desc.place(x=180, y=210, width=470, height=120)
            ...
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.show.showinfo("Delete", "Supplier Deleted Successfully",parent=self.root)
